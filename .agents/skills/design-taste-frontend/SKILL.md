...
* **Max 3 lines** of quote text. If the testimonial is a paragraph: extract the single best sentence.
* **Always pair** with a real profile image (generate or use direct placeholder URL). An empty circle or letter avatar for a testimonial is a tell.
